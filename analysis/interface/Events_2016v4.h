...
// Wed Apr 18 15:29:49 2018 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /xrootd/store/group/nanoAOD/run2_2016v4/tsw/nanoAOD_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nFatJet;
   Float_t         FatJet_area[10];   //[nFatJet]
   Float_t         FatJet_btagCMVA[10];   //[nFatJet]
   Float_t         FatJet_btagCSVV2[10];   //[nFatJet]
   Float_t         FatJet_btagDeepB[10];   //[nFatJet]
   Float_t         FatJet_btagHbb[10];   //[nFatJet]
   Float_t         FatJet_eta[10];   //[nFatJet]
   Float_t         FatJet_mass[10];   //[nFatJet]
   Float_t         FatJet_msoftdrop[10];   //[nFatJet]
   Float_t         FatJet_n2b1[10];   //[nFatJet]
   Float_t         FatJet_n3b1[10];   //[nFatJet]
   Float_t         FatJet_phi[10];   //[nFatJet]
   Float_t         FatJet_pt[10];   //[nFatJet]
   Float_t         FatJet_tau1[10];   //[nFatJet]
   Float_t         FatJet_tau2[10];   //[nFatJet]
   Float_t         FatJet_tau3[10];   //[nFatJet]
   Float_t         FatJet_tau4[10];   //[nFatJet]
   ...
   UInt_t          nGenVisTau;
   Float_t         GenVisTau_eta[5];   //[nGenVisTau]
   Float_t         GenVisTau_mass[5];   //[nGenVisTau]
   Float_t         GenVisTau_phi[5];   //[nGenVisTau]
   Float_t         GenVisTau_pt[5];   //[nGenVisTau]
   Int_t           GenVisTau_charge[5];   //[nGenVisTau]
   ...
   UInt_t          njetID;
   Float_t         jetID_delta[70];   //[njetID]
   Float_t         jetID_axis2[70];   //[njetID]
   Float_t         jetID_axis1[70];   //[njetID]
   Float_t         jetID_ptD[70];   //[njetID]
   Float_t         jetID_cpt1[70];   //[njetID]
   Float_t         jetID_cpt2[70];   //[njetID]
   Float_t         jetID_cpt3[70];   //[njetID]
   Float_t         jetID_npt1[70];   //[njetID]
   Float_t         jetID_npt2[70];   //[njetID]
   Float_t         jetID_npt3[70];   //[njetID]
   Int_t           jetID_cmult[70];   //[njetID]
   Int_t           jetID_nmult[70];   //[njetID]
   Int_t           jetID_dauIdx1[70];
   Int_t           jetID_dauIdx2[70];
   Float_t         jetDau_pt[350];   
   Float_t         jetDau_eta[350];  
   Float_t         jetDau_phi[350];     
   Float_t         jetDau_charge[350]; 
   UInt_t          nJet;
   Float_t         Jet_area[70];   //[nJet]
   Float_t         Jet_btagCMVA[70];   //[nJet]
   Float_t         Jet_btagCSVV2[70];   //[nJet]
   Float_t         Jet_btagDeepB[70];   //[nJet]
   Float_t         Jet_btagDeepC[70];   //[nJet]
   Float_t         Jet_chEmEF[70];   //[nJet]
   Float_t         Jet_chHEF[70];   //[nJet]
   Float_t         Jet_eta[70];   //[nJet]
   Float_t         Jet_mass[70];   //[nJet]
   Float_t         Jet_neEmEF[70];   //[nJet]
   Float_t         Jet_neHEF[70];   //[nJet]
   Float_t         Jet_phi[70];   //[nJet]
   Float_t         Jet_pt[70];   //[nJet]
   Float_t         Jet_qgl[70];   //[nJet]
   Float_t         Jet_rawFactor[70];   //[nJet]
   Float_t         Jet_bReg[70];   //[nJet]
   Int_t           Jet_electronIdx1[70];   //[nJet]
   Int_t           Jet_electronIdx2[70];   //[nJet]
   Int_t           Jet_jetId[70];   //[nJet]
   Int_t           Jet_muonIdx1[70];   //[nJet]
   Int_t           Jet_muonIdx2[70];   //[nJet]
   Int_t           Jet_nConstituents[70];   //[nJet]
   Int_t           Jet_nElectrons[70];   //[nJet]
   Int_t           Jet_nMuons[70];   //[nJet]
   Int_t           Jet_puId[70];   //[nJet]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
  ...
  // Int_t           Pileup_nTrueInt;
   ...
   Float_t         SoftActivityJet_eta[10];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_phi[10];   //[nSoftActivityJet]
   Float_t         SoftActivityJet_pt[10];   //[nSoftActivityJet]
   ...
   Int_t           Jet_genJetIdx[70];   //[nJet]
   Int_t           Jet_hadronFlavour[70];   //[nJet]
   Int_t           Jet_partonFlavour[70];   //[nJet]
   ...
   virtual void     Init(TTree *tree, TTree *had, TTree *hadTruth);
   virtual void     Loop();
...
void Events::Init(TTree *tree, TTree *had, TTree *hadTruth)
{
